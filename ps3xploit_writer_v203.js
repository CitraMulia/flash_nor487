	...
	switch (uaStringCheck) {
		case "PLAYSTATION":
			switch (fwVersion) {
				...
				default:
					alert("Your PS3 is not on FW 4.87! Your current running FW version is " + fwVersion + ", which is not compatible with PS3Xploit Flasher. All features have been disabled");
					disable_btn();
					disable_cb();
					break;
			}
